...
let ConditionsComponent = class ConditionsComponent {
    ...
    startup(file = null) {
        ...
        if (file != null) {
            ...
            fr.onload =
                () => {
                    if (_services_data_service__WEBPACK_IMPORTED_MODULE_3__["DataService"].loadConditionsData(fr.result)) {
    ...
    updateCurrentConditionExpression() {
...
let EmailComponent = class EmailComponent {
    ...
    startup(file = null) {
        ...
        if (file != null) {
            ...
            fr.onload =
                () => {
                    if (_services_data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"].loadEmailData(fr.result)) {
                        this.emails = _services_data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"].emailData;
                        this.startupPage = false;
                    }
                    this.pageIsLoading = false;
                };
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".alignCenter {\n  margin: auto 25%;\n  width: 50%;\n  align-self: center;\n}\n\n.scrollContainer {\n  height: 93%;\n}\n\n.gridContainer {\n  grid-template-columns: 60% 40%;\n}\n\n.mat-card {\n  margin: 10px;\n  padding: 10px 10px 5px 5px;\n  background-color: #5F5F5F;\n  display: grid;\n  grid-template-columns: 90% 10%;\n  grid-template-rows: -webkit-max-content;\n  grid-template-rows: max-content;\n}\n\n.mat-card .mat-card-actions {\n  padding: 0;\n}\n\n.mat-card .mat-card-actions button {\n  height: 90%;\n  margin-right: 8px;\n  margin-bottom: 8px;\n}\n\n.listFooter {\n  grid-template-columns: 33% 33% 33%;\n}\n\n.details {\n  padding: 10px;\n  margin: 10px;\n}\n\n.details * {\n  color: mintcream;\n}\n\n.details h4 {\n  margin: 10px 5px 5px 2px;\n}\n\n.details .mat-checkbox {\n  margin: 2px 10px 2px 2px;\n}\n\n.detailsList {\n  margin: 10px;\n  display: grid;\n  grid-template-columns: 40% 60%;\n  grid-template-rows: -webkit-max-content;\n  grid-template-rows: max-content;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
let DataService = DataService_1 = class DataService {
    ...
    static saveEmailData(data = this.emailData) {
...
const API_KEY = "AIzaSyBqGq0TdG38CZ6mgCr4o-X5wOnwWAqMe5k";
const CLIENT_ID = "950001773289-65v5h9s3ao8gcinc24f35oasqdp4ipca.apps.googleusercontent.com";
let EmailService = class EmailService {
    ...
    getMessageList(pageToken = '', maxMessages = 10, incJunk = true) {
        //@ts-ignore
...
class Condition {
    ...
    static setExpression(con, expr) {
        con.expression = expr;
        con.regExpressions = [];
        con.parsedExpression = "";
        let regExStarted = false;
        let currentRegExFragment = "";
...
class ParsedData {
    static buildParsedData(emails, conditions) {
        let result = [];
        for (let e of emails) {
            let temp = new ParsedData();
            temp.emailID = e.id;
